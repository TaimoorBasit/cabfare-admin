    ...
    el.textContent = `
      ...
      *, *::before, *::after {
      ...
      @media (max-width: 768px) {
        .adm-sidebar { 
          position: fixed !important; top: auto !important; bottom: 0 !important; width: 100% !important; 
          height: auto !important; min-width: 100% !important; border-right: none !important; 
          border-top: 1px solid #eaecf0 !important; z-index: 9999 !important; padding: 6px !important;
          flex-direction: row !important; align-items: center; justify-content: center;
        }
        .adm-sidebar > div:first-child { display: none !important; } /* Hide logo */
        .adm-sidebar > div:last-child { display: none !important; } /* Hide save section */
        .adm-sidebar nav { 
          flex-direction: row !important; overflow-x: auto !important; padding: 0 !important; 
          gap: 12px !important; flex: none !important; width: 100%; justify-content: space-around;
        }
        .adm-sidebar nav button { 
          flex-direction: column !important; padding: 6px !important; font-size: 10px !important; 
          gap: 4px !important; background: transparent !important;
        }
        .adm-main-content { margin-left: 0 !important; width: 100% !important; min-width: 0 !important; overflow-x: hidden !important; padding-bottom: 70px !important; }
                    ...
                    <div key={v.id} style={{ border:`1.5px solid ${PX.gray200}`,borderRadius:12,padding:"1.25rem",marginBottom:"1rem",background: PX.gray50 }}>
                      <div style={{ display:"grid", gridTemplateColumns:"auto 1fr auto", gap:20, alignItems:"start", marginBottom:"1.25rem" }}>
                        ...
                        <div style={{ display:"flex",flexDirection:"column",gap:8,alignItems:"flex-end" }}>
                          ...
                          <div style={{ border: `1.5px solid ${PX.gray200}`, borderRadius: 8, padding: "12px", background: "#fff", textAlign: "center", minWidth: 130, marginTop: "auto" }}>
                            <div style={{ fontSize: 10, fontWeight: 800, color: PX.gray500, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 }}>Standing Rate</div>
                            <div style={{ fontSize: 16, fontWeight: 900, color: PX.navy800 }}>£{((v.standingCostPerDay)||0).toFixed(2)}<span style={{ fontSize: 12, fontWeight: 700, color: PX.navy800 }}>/day</span></div>
                            <div style={{ margin: "8px 0", height: 1, background: PX.gray200 }} />
                            <div style={{ fontSize: 10, fontWeight: 800, color: PX.gray500, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4 }}>Annual Total</div>
                            <div style={{ fontSize: 16, fontWeight: 900, color: PX.navy800 }}>£{((v.annualFixedCosts||[]).reduce((s,x)=>s+(Number(x.amount)||0),0)).toLocaleString()}</div>
                          </div>
                        </div>
                      </div>
